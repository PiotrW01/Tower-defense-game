...
/*            createTurret();
    ...
    private void PlaceTurret()
    {
        ...
        turretTemp.transform.Find("turret sprite").GetComponent<SpriteRenderer>().sortingLayerID = 0;
        turretTemp.transform.Find("lufa holder").GetComponentInChildren<SpriteRenderer>().sortingLayerID = 0;
        turretTemp.transform.Find("lufa holder").GetComponentInChildren<SpriteRenderer>().sortingOrder = 2;
